...
from LiveChess2FEN.detectboard import debug, image_object
from LiveChess2FEN.detectboard import poly_point_isect


__LAPS_SESS = onnxruntime.InferenceSession(
    "LiveChess2FEN/detectboard/models/laps_model.onnx"
)
